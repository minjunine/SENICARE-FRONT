...
export const CS_DETAIL_PATH = (customNumber: string | number) => `${customNumber}/update`;
...
export const HR_DETAIL_ABSOLUTE_PATH = (userId: string) => `${HR_PATH}/${HR_DETAIL_PATH}`;
export const HR_UPDATE_ABSOLUTE_PATH = (userId: string) => `${HR_PATH}/${HR_DETAIL_PATH}`;
