...
function SignIn({ onPathChange }: AuthComponentProps) {
    ...
    return (
        <div  className='auth-box'>
                ...
                <div  className="input-container">
                    <InputBox value={id} onChange={onIdChangHandler} message='' messageError type='text' label='아이디' placeholder='아이디를 입력해주세요.' />
                ...
                <div  className="button-container">
                    <div  className="primary-button full width" onClick={onSignInButtonHandler}>로그인</div>
